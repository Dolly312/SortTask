...
public class SortClass{
	...
	public static void main(String[] args) {
		...
		dlist.add(new Moble(10,112,1234, 14200,3 ));
		dlist.add(new Moble(20,1132,1234, 148900,4 ));
		dlist.add(new Moble(30,182,1234, 156200,2 ));
		dlist.add(new Moble(40,172,1234, 19200,5));
		
		
		// default sorting approach 
		doPrint(dlist,"Default Data Rendering ");
